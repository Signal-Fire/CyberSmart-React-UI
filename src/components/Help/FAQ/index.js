...
const panes = [
    ...
    { menuItem: 'What is a Device?', render: () => <Tab.Pane>A Device is one of the CyberSmart plugs, with one of your appliances plugged in! Whether it be a lamp or phone charger, blender or sex toy!</Tab.Pane> },
    { menuItem: 'How can I change my User Settings', render: () => <Tab.Pane>Head up to the settings cog on the top right of the page, give it a dick and select User Settings, you can now change your name</Tab.Pane> },
